          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="me-auto">
              ...
              <NavDropdown title="Cadastros" id="basic-nav-dropdown">
                <Link className="dropdown-item" to="/cadastro-patrimonio">
                  Cadastro de Patrimônio
                </Link>
                <Link className="dropdown-item" to="/cadastro-laboratorio">
                  Cadastro de Laboratório
                </Link>
                <Link className="dropdown-item" to="/cadastro-usuario">
                  Cadastro de Usuário
                </Link>
              </NavDropdown>

              <NavDropdown title="Manutenção" id="basic-nav-dropdown">
                <Link className="dropdown-item" to="/manutencao">
                  Consulta de Manutenção
                </Link>
                <Link className="dropdown-item" to="/solicitacaoManutencao">
                  Solicitação de Manutenção
                </Link>
              </NavDropdown>
              <Link className="nav-link" to="/cronograma-lab">
